...
-It must be loaded onto an Arduino plugged into your computer, with the PPM signal from an RC Tx going into the Arduino digital Pin 2 (preferably though a 1KOhm resistor), and the PPM ground going to one of the Arduino's GND pins.
